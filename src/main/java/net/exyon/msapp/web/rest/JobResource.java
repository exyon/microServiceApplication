...
import net.exyon.msapp.domain.Job;

import net.exyon.msapp.repository.JobRepository;
...
import net.exyon.msapp.service.dto.JobDTO;
import net.exyon.msapp.service.mapper.JobMapper;
